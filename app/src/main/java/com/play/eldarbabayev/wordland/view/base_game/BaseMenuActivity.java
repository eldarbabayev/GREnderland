...
import com.play.eldarbabayev.wordland.presenter.base_game.BaseMenuActivityOps;
...
public class BaseMenuActivity
        extends GenericActivity<BaseMenuActivity,
        BaseMenuActivityOps,
        BaseMenuActivityOps> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.onCreate(BaseMenuActivityOps.class,
                this);
    ...
    private void initialiseDisplay() {
        ...
        Drawable dr = getResources().getDrawable(R.drawable.green);
    ...
    public void playButton(View v) {
        ...
        Intent goToBasePlayActivity = new Intent(BaseMenuActivity.this, BasePlayActivity.class);
        startActivity(goToBasePlayActivity);
    }
    ...
    public void dictionaryButton(View v) {
        // go to dictionary
        Intent goToBaseDictionaryActivity = new Intent(BaseMenuActivity.this, BaseDictionaryActivity.class);
        startActivity(goToBaseDictionaryActivity);
    }
}
